...
if ($Help) {
    ...
    Write-Host "  .\quick-post.ps1 -Title '文章標題' -Category '分類' -Tags '標籤1,標籤2'"
    Write-Host ""
    Write-Host "範例:" -ForegroundColor Yellow
    Write-Host "  .\quick-post.ps1 -Title 'Python 教學' -Category '程式語言' -Tags 'Python,教學'"
    Write-Host "  .\quick-post.ps1 -Title '我的心得' -Category '生活分享'"
    Write-Host ""
    return
}
